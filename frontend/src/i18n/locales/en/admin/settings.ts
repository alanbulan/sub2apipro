export default {
    settings: {
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream compatible sites. Account rates change only when the separate sync switch is enabled.',
      ...
      site: {
        ...
        siteSubtitlePlaceholder: 'API Gateway Platform',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on platform orders; the upstream type is sent as EasyPay type.',
