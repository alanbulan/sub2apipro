export default {
    accounts: {
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. The platform cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      grok: {
        ...
        ttsTextPlaceholder: 'Example: Hello from platform connectivity test.',
        ttsTextDefault: 'Hello from platform account connectivity test.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another compatible gateway instance.',
