<template>
  <div class="relative" ref="dropdownRef">
    <button
      ...
      class="app-theme-control inline-flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs font-medium shadow-sm transition-colors"
    ...
    <div
      v-if="showDropdown"
      class="app-theme-menu-surface absolute right-0 z-20 mt-1 w-44 rounded-lg border border-gray-200 bg-white shadow-lg dark:border-dark-600 dark:bg-dark-800"
    >
      <div class="p-1.5">
        <button
          @click="$emit('update:enabled', !enabled)"
          class="app-theme-menu-item flex w-full items-center justify-between rounded-md px-3 py-1.5 text-sm"
        >
