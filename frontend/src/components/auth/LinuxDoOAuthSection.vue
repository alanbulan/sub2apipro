...
<style scoped>
.linuxdo-icon {
  --linuxdo-icon-base: #efefef;
  --linuxdo-icon-accent: #feb005;
  --linuxdo-icon-ink: #1d1d1f;
  color: rgb(233, 84, 32);
  width: 20px;
  height: 20px;
}
