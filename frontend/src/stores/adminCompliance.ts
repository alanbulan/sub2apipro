...
const FALLBACK_ZH_PHRASE = '我已阅读、理解并同意本平台部署与运营合规承诺'
const FALLBACK_EN_PHRASE = 'I have read, understood, and agree to this platform Deployment and Operation Compliance Commitment'
